...
void matrix_mult_cblas(const double *A, const double *B, double *C, int AX,
                       int AY, int BY) {
  // from doc:
  ...
  // columns of the matrix C. K specifies  the number of columns of the matrix
  // op(A) and the number of rows of the matrix op(B). i.e. in my terms, M is
  // AX, N is BY, K is AY
