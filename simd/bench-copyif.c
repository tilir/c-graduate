...
//-----------------------------------------------------------------------------
//
// Vectorized copy-if benchmark with lookup table
// > gcc -march=tigerlake -O2 bench-copyif.c
// > ./a.out
//
//-----------------------------------------------------------------------------
...
// 16-element permutations for 16-bit masks
__attribute__((aligned(64))) int permutation[(1 << 16)][16];
